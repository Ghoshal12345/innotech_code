...
if (mysqli_num_rows($result) > 0) {
  ...
  echo "Full Name ______________      "   . $row["Full_name"];
  echo "<p>       </p>";

  echo "Mobile ______________      "   . $row["MOBIL"];
  echo "<p>       </p>";
  echo "Designation ______________     "   . $row["Designation"];
  echo "<p>       </p>";
  echo "Address ______________     "   . $row["Address"];
  echo "<p>       </p>";
  echo " Email ______________      "   . $row["email"];
  echo "<p>       </p>";
  echo "School ______________     "   . $row["school"];
  echo "<p>       </p>";
  echo "Courses ______________     "   . $row["courses"];
  echo "<p>       </p>";
  echo "Deparment ______________      "   . $row["department"];
  echo "<p>       </p>";
  ...
  <style>
    @media screen and (min-width: 50rem) {
      ...
      .cmd button {
        ...
        margin: 5px;
        align: center;
        color: #800000 font-family: 'Nanum Gothic', sans-serif;
        margin-left: 80px;
        margin-top: 20px;
      }
...
<div class="footer">
  ...
  <p>All Copy Right Reserved <span>&#169;</span> KIET GROUP OF INSTITUTIONS</p>
</div>
